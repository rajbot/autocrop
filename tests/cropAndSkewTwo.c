...
compile with:
g++ -ansi -Werror -D_BSD_SOURCE -DANSI -fPIC -O3  -I../leptonlib-1.56/src -I/usr/X11R6/include  -DL_LITTLE_ENDIAN -o cropAndSkewTwo cropAndSkewTwo.c ../leptonlib-1.56/lib/nodebug/liblept.a -ltiff -ljpeg -lpng -lz -lm
