...
compile with:
g++ -ansi -Werror -D_BSD_SOURCE -DANSI -fPIC -O3  -I../src -I/usr/X11R6/include  -DL_LITTLE_ENDIAN -o autoCrop autoCrop.c ../lib/nodebug/liblept.a -ltiff -ljpeg -lpng -lz -lm
